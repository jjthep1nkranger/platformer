...
//    public float width;
//    public float height;
//    public EnemySpritesheet enemySpritesheet;
//    public String currentAnimation;
//    protected float stateTime;// time of the state
//    protected HashMap<String, Animation> animations;
//
//    public EnemySprite(Vector2 position, int width, int height){
//        this.position = position;//positions the player in the bottom right corner of the screen
//        this.width = width * LevelController.UNIT_SCALE;
//        this.height = height * LevelController.UNIT_SCALE;
//        spriteSheet = new Spritesheet("img/enemy-barnacle.png", width, height);
